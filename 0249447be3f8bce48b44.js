...
document.querySelectorAll('[data-product-quantity]').forEach(item => {
   item.addEventListener('change' , () => {
      ...
      const quantity = parent.querySelector('[data-product-quantity]').value;
      const totalPriceforProducts = PricePerUnite * quantity
       totalPriceforAllProduct = totalPriceforAllProduct + totalPriceforProducts;
      })
